 ...
 */
router.post('/resend-verification', emailVerificationLimiter, validate(userValidation.email), authController.resendVerificationEmail);
 ...
 */
router.post('/forgot-password', passwordResetLimiter, validate(userValidation.email), authController.requestPasswordReset);
 ...
 *         description: Invalid or expired token
 */
router.post('/reset-password', passwordResetLimiter, validate(userValidation.resetPassword), authController.resetPassword);
 ...
 */
router.post('/change-password', authenticate, validate(userValidation.changePassword), authController.changePassword);
